...
public class QueryBuilderWithSchemaTest extends BaseCoreStmtTest {
	...
	public void testAddColumns() throws Exception {
		QueryBuilder<SchemaFoo, Integer> qb = new QueryBuilder<SchemaFoo, Integer>(databaseType, baseSchemaFooTableInfo, null);
		String[] columns1 = new String[] { SchemaFoo.ID_COLUMN_NAME, SchemaFoo.VAL_COLUMN_NAME };
	...
	public void testDontAddIdColumn() throws Exception {
		QueryBuilder<SchemaFoo, Integer> qb = new QueryBuilder<SchemaFoo, Integer>(databaseType, baseSchemaFooTableInfo, null);
		String column = SchemaFoo.VAL_COLUMN_NAME;
		String idColumn = SchemaFoo.ID_COLUMN_NAME;
	...
	public void testAddColumnsIterable() throws Exception {
		...
		columns1.add(SchemaFoo.ID_COLUMN_NAME);
		columns1.add(SchemaFoo.VAL_COLUMN_NAME);
		String column2 = "equal";
		qb.selectColumns(columns1);
		qb.selectColumns(column2);
		StringBuilder sb = new StringBuilder();
	...
	public void testGroupBy() throws Exception {
		QueryBuilder<SchemaFoo, Integer> qb = new QueryBuilder<SchemaFoo, Integer>(databaseType, baseSchemaFooTableInfo, null);
		String field1 = SchemaFoo.VAL_COLUMN_NAME;
		qb.groupBy(field1);
		String field2 = SchemaFoo.ID_COLUMN_NAME;
		qb.groupBy(field2);
		StringBuilder sb = new StringBuilder();
		sb.append("SELECT * FROM ");
		databaseType.appendEscapedEntityName(sb, baseSchemaFooTableInfo.getSchemaName());
	...
	public void testOrderByDesc() throws Exception {
		QueryBuilder<SchemaFoo, Integer> qb = new QueryBuilder<SchemaFoo, Integer>(databaseType, baseSchemaFooTableInfo, null);
		String field = SchemaFoo.VAL_COLUMN_NAME;
	...
	public void testOffsetWorks() throws Exception {
		Dao<SchemaFoo, Integer> dao = createDao(SchemaFoo.class, true);
		SchemaFoo SchemaFoo1 = new SchemaFoo();
		assertEquals(1, dao.create(SchemaFoo1));
		SchemaFoo SchemaFoo2 = new SchemaFoo();
		assertEquals(1, dao.create(SchemaFoo2));

		assertEquals(2, dao.queryForAll().size());

		QueryBuilder<SchemaFoo, Integer> qb = dao.queryBuilder();
		long offset = 1;
		long limit = 2;
		qb.offset(offset);
		qb.limit(limit);
		List<SchemaFoo> results = dao.query(qb.prepare());
	...
	public void testLimitAfterSelect() throws Exception {
		QueryBuilder<SchemaFoo, Integer> qb =
				new QueryBuilder<SchemaFoo, Integer>(new LimitAfterSelectDatabaseType(), baseSchemaFooTableInfo, null);
		long limit = 103;
		qb.limit(limit);
		StringBuilder sb = new StringBuilder();
	...
	public void testWhere() throws Exception {
		QueryBuilder<SchemaFoo, Integer> qb = new QueryBuilder<SchemaFoo, Integer>(databaseType, baseSchemaFooTableInfo, null);
		Where<SchemaFoo, Integer> where = qb.where();
		String val = "1";
		where.eq(SchemaFoo.ID_COLUMN_NAME, val);
		StringBuilder sb = new StringBuilder();
		sb.append("SELECT * FROM ");
		databaseType.appendEscapedEntityName(sb, baseSchemaFooTableInfo.getSchemaName());
		sb.append('.');
	...
	public void testPrepareStatement() throws Exception {
		Dao<SchemaFoo, Integer> dao = createDao(SchemaFoo.class, false);
		QueryBuilder<SchemaFoo, Integer> qb = new QueryBuilder<SchemaFoo, Integer>(databaseType, baseSchemaFooTableInfo, dao);
		PreparedQuery<SchemaFoo> stmt = qb.prepare();
		stmt.getStatement();
		StringBuilder sb = new StringBuilder();
		sb.append("SELECT * FROM ");
		databaseType.appendEscapedEntityName(sb, baseSchemaFooTableInfo.getSchemaName());
	...
	public void testLimitInline() throws Exception {
		Dao<SchemaFoo, Integer> dao = createDao(SchemaFoo.class, false);
		QueryBuilder<SchemaFoo, Integer> qb = new QueryBuilder<SchemaFoo, Integer>(new LimitInline(), baseSchemaFooTableInfo, dao);
		long limit = 213;
		qb.limit(limit);
		PreparedQuery<SchemaFoo> stmt = qb.prepare();
		stmt.getStatement();
	...
	public void testShortCuts() throws Exception {
		...
		SchemaFoo SchemaFoo2 = new SchemaFoo();
		assertEquals(1, dao.create(SchemaFoo2));
		List<SchemaFoo> results = dao.queryBuilder().where().eq(SchemaFoo.ID_COLUMN_NAME, SchemaFoo2.id).query();
		assertEquals(1, results.size());
		assertEquals(SchemaFoo2.id, results.get(0).id);
		Iterator<SchemaFoo> iterator = dao.queryBuilder().where().eq(SchemaFoo.ID_COLUMN_NAME, SchemaFoo2.id).iterator();
		assertTrue(iterator.hasNext());
		assertEquals(SchemaFoo2.id, iterator.next().id);
	...
	public void testOrderByRaw() throws Exception {
		...
		SchemaFoo2.equal = 7;
		assertEquals(1, dao.create(SchemaFoo2));
		List<SchemaFoo> results = dao.queryBuilder()
				.orderByRaw("(" + SchemaFoo.VAL_COLUMN_NAME + "+" + SchemaFoo.EQUAL_COLUMN_NAME + ") DESC")
				.query();
		assertEquals(2, results.size());
		assertEquals(SchemaFoo2.id, results.get(0).id);
		assertEquals(SchemaFoo1.id, results.get(1).id);
	}
	...
	public void testOrderByRawArg() throws Exception {
		...
		assertEquals(1, dao.create(SchemaFoo2));
		List<SchemaFoo> results = dao.queryBuilder()
				.orderByRaw("(" + SchemaFoo.VAL_COLUMN_NAME + " = ? ) DESC", new SelectArg(SqlType.INTEGER, 2))
				.query();
		assertEquals(2, results.size());
		assertEquals(SchemaFoo2.id, results.get(0).id);
		assertEquals(SchemaFoo1.id, results.get(1).id);
		results = dao.queryBuilder()
				.orderByRaw("(" + SchemaFoo.VAL_COLUMN_NAME + " = ? )", new SelectArg(SqlType.INTEGER, 2))
				.query();
		assertEquals(2, results.size());
		assertEquals(SchemaFoo1.id, results.get(0).id);
		assertEquals(SchemaFoo2.id, results.get(1).id);
	}
	...
	public void testOrderByRawAndOrderBy() throws Exception {
		...
		SchemaFoo2.equal = 7;
		assertEquals(1, dao.create(SchemaFoo2));
		SchemaFoo SchemaFoo3 = new SchemaFoo();
		SchemaFoo3.val = 7;
		SchemaFoo3.equal = 5;
		assertEquals(1, dao.create(SchemaFoo3));
		List<SchemaFoo> results = dao.queryBuilder()
				.orderByRaw("(" + SchemaFoo.VAL_COLUMN_NAME + "+" + SchemaFoo.EQUAL_COLUMN_NAME + ") DESC")
				.query();
		assertEquals(3, results.size());
		assertEquals(SchemaFoo2.id, results.get(0).id);
		assertEquals(SchemaFoo3.id, results.get(1).id);
		assertEquals(SchemaFoo1.id, results.get(2).id);

		results = dao.queryBuilder()
				.orderByRaw("(" + SchemaFoo.VAL_COLUMN_NAME + "+" + SchemaFoo.EQUAL_COLUMN_NAME + ") DESC")
				.orderBy(SchemaFoo.VAL_COLUMN_NAME, false)
				.query();
		assertEquals(3, results.size());
		assertEquals(SchemaFoo3.id, results.get(0).id);
		assertEquals(SchemaFoo2.id, results.get(1).id);
		assertEquals(SchemaFoo1.id, results.get(2).id);

		results = dao.queryBuilder()
				.orderBy(SchemaFoo.VAL_COLUMN_NAME, true)
				.orderByRaw("(" + SchemaFoo.VAL_COLUMN_NAME + "+" + SchemaFoo.EQUAL_COLUMN_NAME + ") DESC")
				.query();
		assertEquals(3, results.size());
		assertEquals(SchemaFoo1.id, results.get(0).id);
		assertEquals(SchemaFoo2.id, results.get(1).id);
		assertEquals(SchemaFoo3.id, results.get(2).id);
	}

	@Test
	public void testQueryForForeign() throws Exception {
		Dao<SchemaFoo, Integer> SchemaFooDao = createDao(SchemaFoo.class, true);
		Dao<ForeignSchemaFoo, Object> foreignDao = createDao(ForeignSchemaFoo.class, true);

		SchemaFoo SchemaFoo = new SchemaFoo();
		SchemaFoo.val = 1231;
		assertEquals(1, SchemaFooDao.create(SchemaFoo));

		ForeignSchemaFoo foreign = new ForeignSchemaFoo();
		foreign.foo = SchemaFoo;
		assertEquals(1, foreignDao.create(foreign));

		// use the auto-extract method to extract by id
		List<ForeignSchemaFoo> results = foreignDao.queryBuilder().where().eq(ForeignSchemaFoo.FOO_COLUMN_NAME, SchemaFoo).query();
		assertEquals(1, results.size());
		assertEquals(foreign.id, results.get(0).id);

		// query for the id directly
		List<ForeignSchemaFoo> results2 = foreignDao.queryBuilder().where().eq(ForeignSchemaFoo.FOO_COLUMN_NAME, SchemaFoo.id).query();
	...
	public void testInnerCountOf() throws Exception {
		Dao<SchemaFoo, String> SchemaFooDao = createDao(SchemaFoo.class, true);
		...
		SchemaFoo SchemaFoo1 = new SchemaFoo();
		SchemaFoo1.val = bar1.id;
		assertEquals(1, SchemaFooDao.create(SchemaFoo1));
		SchemaFoo SchemaFoo2 = new SchemaFoo();
		SchemaFoo2.val = bar1.id;
		assertEquals(1, SchemaFooDao.create(SchemaFoo2));
		SchemaFoo SchemaFoo3 = new SchemaFoo();
		SchemaFoo3.val = bar1.id + 1;
		assertEquals(1, SchemaFooDao.create(SchemaFoo3));
		...
		QueryBuilder<SchemaFoo, String> SchemaFooQb = SchemaFooDao.queryBuilder();
		List<Integer> idList = new ArrayList<Integer>();
		idList.add(SchemaFoo1.id);
		idList.add(SchemaFoo2.id);
		idList.add(SchemaFoo3.id);
		SchemaFooQb.where().in(SchemaFoo.ID_COLUMN_NAME, idList).and().in(SchemaFoo.VAL_COLUMN_NAME, barQb);

		SchemaFooQb.setCountOf(true);
		assertEquals(1, SchemaFooQb.getSelectColumnCount());
		assertEquals("COUNT(*)", SchemaFooQb.getSelectColumnsAsString());
		assertEquals(2, SchemaFooDao.countOf(SchemaFooQb.prepare()));
	}
	...
	public void testMixAndOrInline() throws Exception {
		...
		SchemaFoo SchemaFoo1 = new SchemaFoo();
		SchemaFoo1.val = 10;
		SchemaFoo1.stringField = "zip";
		assertEquals(1, dao.create(SchemaFoo1));
		SchemaFoo SchemaFoo2 = new SchemaFoo();
		SchemaFoo2.val = SchemaFoo1.val;
		SchemaFoo2.stringField = SchemaFoo1.stringField + "zap";
		assertEquals(1, dao.create(SchemaFoo2));
		 ...
		 */
		QueryBuilder<SchemaFoo, String> qb = dao.queryBuilder();
		Where<SchemaFoo, String> where = qb.where();
		where.eq(SchemaFoo.VAL_COLUMN_NAME, SchemaFoo1.val)
				.and()
				.eq(SchemaFoo.STRING_COLUMN_NAME, SchemaFoo1.stringField)
				.or()
				.eq(SchemaFoo.STRING_COLUMN_NAME, SchemaFoo2.stringField);

		List<SchemaFoo> results = dao.queryForAll();
		assertEquals(2, results.size());
		assertEquals(SchemaFoo1.id, results.get(0).id);
		assertEquals(SchemaFoo2.id, results.get(1).id);
		...
		qb = dao.queryBuilder();
		where = qb.where();
		where.and(where.eq(SchemaFoo.VAL_COLUMN_NAME, SchemaFoo1.val), //
				where.or(where.eq(SchemaFoo.STRING_COLUMN_NAME, SchemaFoo1.stringField), //
						where.eq(SchemaFoo.STRING_COLUMN_NAME, SchemaFoo2.stringField)));
		...
		where.eq(SchemaFoo.VAL_COLUMN_NAME, SchemaFoo1.val);
		where.and();
		where.eq(SchemaFoo.STRING_COLUMN_NAME, SchemaFoo1.stringField);
		where.or();
		where.eq(SchemaFoo.STRING_COLUMN_NAME, SchemaFoo2.stringField);
	...
	public void testBadJoin() throws Exception {
		Dao<Bar, Integer> barDao = createDao(Bar.class, true);
		Dao<SchemaFoo, Integer> SchemaFooDao = createDao(SchemaFoo.class, true);
		SchemaFooDao.queryBuilder().join(barDao.queryBuilder()).query();
	}
	...
	public void testColumnArg() throws Exception {
		...
		int val = 3123123;
		SchemaFoo1.val = val;
		SchemaFoo1.equal = val;
		assertEquals(1, SchemaFooDao.create(SchemaFoo1));
		SchemaFoo SchemaFoo2 = new SchemaFoo();
		SchemaFoo2.val = val;
		SchemaFoo2.equal = val + 1;
		assertEquals(1, SchemaFooDao.create(SchemaFoo2));

		QueryBuilder<SchemaFoo, Integer> qb = SchemaFooDao.queryBuilder();
		qb.where().eq(SchemaFoo.VAL_COLUMN_NAME, new ColumnArg(SchemaFoo.EQUAL_COLUMN_NAME));
		List<SchemaFoo> results = qb.query();
		assertNotNull(results);
		assertEquals(1, results.size());
		assertEquals(SchemaFoo1.id, results.get(0).id);
	}
	...
	public void testColumnArgString() throws Exception {
		...
		StringColumnArg SchemaFoo1 = new StringColumnArg();
		String val = "3123123";
		SchemaFoo1.str1 = val;
		SchemaFoo1.str2 = val;
		assertEquals(1, dao.create(SchemaFoo1));
		StringColumnArg SchemaFoo2 = new StringColumnArg();
		SchemaFoo2.str1 = val;
		SchemaFoo2.str2 = val + "...";
		assertEquals(1, dao.create(SchemaFoo2));
	...
	public void testHavingOrderBy() throws Exception {
		Dao<SchemaFoo, Object> SchemaFooDao = createDao(SchemaFoo.class, true);
		...
		SchemaFoo3.val = 30;
		assertEquals(1, SchemaFooDao.create(SchemaFoo3));
		SchemaFoo SchemaFoo4 = new SchemaFoo();
		SchemaFoo4.val = 40;
		assertEquals(1, SchemaFooDao.create(SchemaFoo4));

		QueryBuilder<SchemaFoo, Object> qb = SchemaFooDao.queryBuilder();
		qb.groupBy(SchemaFoo.ID_COLUMN_NAME);
		qb.orderBy(SchemaFoo.VAL_COLUMN_NAME, false);
		qb.having("val < " + SchemaFoo3.val);
		List<SchemaFoo> results = qb.query();
		assertEquals(2, results.size());
		assertEquals(SchemaFoo2.val, results.get(0).val);
		assertEquals(SchemaFoo1.val, results.get(1).val);
	}

	@Test
	public void testMaxJoin() throws Exception {
		Dao<SchemaFoo, Object> dao = createDao(SchemaFoo.class, true);
		...
		SchemaFoo SchemaFoo4 = new SchemaFoo();
		SchemaFoo4.val = 40;
		assertEquals(1, dao.create(SchemaFoo4));

		QueryBuilder<SchemaFoo, Object> iqb = dao.queryBuilder();
		iqb.selectRaw("max(id)");

		QueryBuilder<SchemaFoo, Object> oqb = dao.queryBuilder();
		SchemaFoo result = oqb.where().in(SchemaFoo.ID_COLUMN_NAME, iqb).queryForFirst();
		assertNotNull(result);
		assertEquals(SchemaFoo4.id, result.id);
	}
	...
	public void testQueryRawMax() throws Exception {
		...
		SchemaFoo SchemaFoo1 = new SchemaFoo();
		SchemaFoo1.stringField = "1";
		SchemaFoo1.val = 10;
		assertEquals(1, dao.create(SchemaFoo1));
		SchemaFoo SchemaFoo2 = new SchemaFoo();
		SchemaFoo2.stringField = "1";
		SchemaFoo2.val = 20;
		assertEquals(1, dao.create(SchemaFoo2));
		SchemaFoo SchemaFoo3 = new SchemaFoo();
		SchemaFoo3.stringField = "2";
		SchemaFoo3.val = 30;
		assertEquals(1, dao.create(SchemaFoo3));
		SchemaFoo SchemaFoo4 = new SchemaFoo();
		SchemaFoo4.stringField = "2";
		SchemaFoo4.val = 40;
		assertEquals(1, dao.create(SchemaFoo4));

		QueryBuilder<SchemaFoo, Object> qb = dao.queryBuilder();
		qb.selectRaw("string, max(val) as val");
		qb.groupBy(SchemaFoo.STRING_COLUMN_NAME);
		GenericRawResults<SchemaFoo> results = dao.queryRaw(qb.prepareStatementString(), dao.getRawRowMapper());
		assertNotNull(results);
		CloseableIterator<SchemaFoo> iterator = results.closeableIterator();
		try {
			assertTrue(iterator.hasNext());
			assertEquals(SchemaFoo2.val, iterator.next().val);
			assertTrue(iterator.hasNext());
			assertEquals(SchemaFoo4.val, iterator.next().val);
			assertFalse(iterator.hasNext());
		} finally {
			iterator.close();
		}
	...
	public void testQueryColumnsPlusQueryRawMax() throws Exception {
		...
		QueryBuilder<SchemaFoo, Object> qb = dao.queryBuilder();
		qb.selectColumns(SchemaFoo.STRING_COLUMN_NAME);
		...
		try {
			assertTrue(iterator.hasNext());
			SchemaFoo result = iterator.next();
			assertEquals(SchemaFoo2.val, result.val);
			assertEquals(SchemaFoo2.stringField, result.stringField);
			assertTrue(iterator.hasNext());
			result = iterator.next();
			assertEquals(SchemaFoo3.val, result.val);
			assertEquals(SchemaFoo3.stringField, result.stringField);
			assertFalse(iterator.hasNext());
		} finally {
			iterator.close();
		}
	...
	public void testJoinTwoColumns() throws Exception {
		...
		SchemaFoo SchemaFoo1 = new SchemaFoo();
		SchemaFoo1.val = 123213213;
		SchemaFoo1.stringField = "stuff";
		SchemaFooDao.create(SchemaFoo1);

		SchemaFoo SchemaFoo2 = new SchemaFoo();
		SchemaFoo2.stringField = "not stuff";
		SchemaFooDao.create(SchemaFoo2);

		StringColumnArg sca1 = new StringColumnArg();
		sca1.str1 = SchemaFoo1.stringField;
		scaDao.create(sca1);

		StringColumnArg sca2 = new StringColumnArg();
		sca2.str1 = SchemaFoo2.stringField;
		scaDao.create(sca2);
		...
		QueryBuilder<SchemaFoo, Integer> SchemaFooQb = SchemaFooDao.queryBuilder();
		SchemaFooQb.where().eq(SchemaFoo.VAL_COLUMN_NAME, SchemaFoo1.val);

		QueryBuilder<StringColumnArg, Integer> scaQb = scaDao.queryBuilder();
		scaQb.join(StringColumnArg.STR1_FIELD, SchemaFoo.STRING_COLUMN_NAME, SchemaFooQb);
		...
		SchemaFooQb.reset();
		SchemaFooQb.where().eq(SchemaFoo.VAL_COLUMN_NAME, SchemaFoo2.val);
	...
	public void testLeftJoinTwoColumns() throws Exception {
		...
		scaQb.reset();
		scaQb.join(StringColumnArg.STR1_FIELD, SchemaFoo.STRING_COLUMN_NAME, SchemaFooQb, JoinType.LEFT, JoinWhereOperation.AND);
		results = scaQb.query();
		assertNotNull(results);
		assertEquals(2, results.size());
		assertEquals(sca1.id, results.get(0).id);
	...
	public void testUtf8() throws Exception {
		...
		SchemaFoo SchemaFoo = new SchemaFoo();
		SchemaFoo.stringField = "اعصاب";
		assertEquals(1, dao.create(SchemaFoo));

		QueryBuilder<SchemaFoo, Integer> qb = dao.queryBuilder();

		List<SchemaFoo> results = qb.where().like(SchemaFoo.STRING_COLUMN_NAME, '%' + SchemaFoo.stringField + '%').query();
		assertNotNull(results);
		assertEquals(1, results.size());
		assertEquals(SchemaFoo.id, results.get(0).id);
		assertEquals(SchemaFoo.stringField, results.get(0).stringField);

		qb.reset();
		results = qb.where().like(SchemaFoo.STRING_COLUMN_NAME, new SelectArg('%' + SchemaFoo.stringField + '%')).query();
		assertNotNull(results);
		assertEquals(1, results.size());
		assertEquals(SchemaFoo.id, results.get(0).id);
		assertEquals(SchemaFoo.stringField, results.get(0).stringField);
	...
	public void testCountInReadOnlyField() throws Exception {
		...
		AsField SchemaFoo1 = new AsField();
		int val1 = 123213;
		SchemaFoo1.val = val1;
		assertEquals(1, dao.create(SchemaFoo1));

		AsField SchemaFoo2 = new AsField();
		int val2 = 122433213;
		SchemaFoo2.val = val2;
		assertEquals(1, dao.create(SchemaFoo2));
	...
	private static class LimitInline extends BaseDatabaseType {
		...
		protected String[] getDriverClassNames() {
			return new String[] { "SchemaFoo.bar.baz" };
		}
