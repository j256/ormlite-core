package com.j256.ormlite.core.logger;
 ...
 * 
 * <p>
 * To set the logger to a particular type, set the system property ("com.j256.ormlite.core.logger.type") contained in
 * {@link #LOG_TYPE_SYSTEM_PROPERTY} ("com.j256.ormlite.core.logger.type") to be one of the values in
 * {@link LoggerFactory.LogType} enum.
 * </p>
 */
public class LoggerFactory {

	public static final String LOG_TYPE_SYSTEM_PROPERTY = "com.j256.ormlite.core.logger.type";
	 ...
	 */
	public enum LogType {
		SLF4J("org.slf4j.LoggerFactory", "com.j256.ormlite.core.logger.Slf4jLoggingLog"),
		/**
		...
		COMMONS_LOGGING("org.apache.commons.logging.LogFactory", "com.j256.ormlite.core.logger.CommonsLoggingLog"),
		LOG4J2("org.apache.logging.log4j.LogManager", "com.j256.ormlite.core.logger.Log4j2Log"),
		LOG4J("org.apache.log4j.Logger", "com.j256.ormlite.core.logger.Log4jLog"),
		...
		JAVA_UTIL("java.util.logging.Logger", "com.j256.ormlite.core.logger.JavaUtilLog"),
		// end
		;
