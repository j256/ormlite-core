...
public class LocalLog implements Log {
	...
	public static final String LOCAL_LOG_LEVEL_PROPERTY = "com.j256.ormlite.core.logger.level";
	public static final String LOCAL_LOG_FILE_PROPERTY = "com.j256.ormlite.core.logger.file";
