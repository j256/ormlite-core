...
public class SchemaUtils {
     ...
     * @param dataClass        The class for which a schema will be created.
     ...
     * @return The number of statements executed to do so.
     */
    public static <T> int createSchema(ConnectionSource connectionSource, String schemaName)
            throws SQLException {
     ...
     *
     * @param databaseType The type of database which will be executing the create schema statements.
     * @param schemaName   Schema Name.
     ...
     *
     * @param connectionSource Associated connection source.
     * @param dataClass        The class for which a schema will be dropped.
