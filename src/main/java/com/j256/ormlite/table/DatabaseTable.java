...
public @interface DatabaseTable {
	...
	/**
	 * The name of the table in the database. If not set then the name is taken from the class name lowercased.
	 */
	String tableName() default "";

	/**
	 * The name of schema in the database. If not set then queries invoked without schema.
	 */
